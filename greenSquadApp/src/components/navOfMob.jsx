  ...
  return (
    <>
      <ul className="md:hidden flex w-full justify-between mr-7">
          <li><Link to="/">
            <div className='w-17 h-7  bg-[#538e3c] rounded-[11px]  flex items-center justify-center'>
          ...
          <li><Link to="/contact"> <div className='w-17 h-7  bg-[#538e3c] rounded-[11px]  flex items-center justify-center'>
