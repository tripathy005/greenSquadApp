...
export default function navbar() {
  return (
    <>
      <div className='h-23 md:h-19 w-full px-3  md:px-10 lg:px-15 xl:px-25 py-3 flex flex-col bg-[linear-gradient(to_top,#249138_0%,#1D782E_25%,#186226_50%,#134F1E_75%,#0F3D17_100%)]'>
