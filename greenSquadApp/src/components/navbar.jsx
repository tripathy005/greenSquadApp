...
export default function navbar() {
  return (
    <>
      <div className='h-23 md:h-20 w-full px-3  md:px-10 lg:px-15 xl:px-25 py-3 flex flex-col sticky top-0 left-0  bg-[linear-gradient(to_top,#249138_0%,#1D782E_25%,#186226_50%,#134F1E_75%,#0F3D17_100%)]'>
        <div className=" mb-2 md:mb-0  flex md:items-end text-[#E2F6E8]  ">
